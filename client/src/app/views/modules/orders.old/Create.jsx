        ...
        <Table>
          ...
          <TableFooter>
            <TableRow>
              <TableRowColumn>
                <SelectField
                  value={this.state.currentProduct.wear}
              ...
              <TableRowColumn>
                <SelectField
                  value={this.state.currentProduct.service}
                  onChange={(event, index, value) => {
                    const wear = this.state.currentProduct.wear
                ...
                >
                  { this.state.products.filter(
                    (item) => item.wear === this.state.currentProduct.wear
                  ).map((item, index) =>
                    <MenuItem
                      key={index}
                      value={item.service}
